export const CATEGORY_MAP: Record<string, string[]> = {
  ...
  Subscriptions: ['netflix','spotify','hulu','amazon prime','apple.com/bill','google one','openai','chatgpt','youtube','claude.ai','anthropic','disney+','hbo','max.com','peacock','paramount','crunchyroll','adobe','microsoft 365','dropbox','icloud','google storage','uber one','uber *one','instacart*subscri'],
  ...
  'CC Payment':  ['payment to chase','payment to discover','payment to citi','payment to amex','payment to bofa','payment to bank of america','chase autopay','discover autopay','autopay payment','discover e-payment'],
  Transfer:      ['online transfer to chk','transfer to chk','online transfer to sav','zelle to','venmo to','transfer to sav'],
};
